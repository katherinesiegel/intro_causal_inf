...
## The data
The data are in the file *matching_ipw_data_full.csv.*
...
First, you'll need to extract the matched data and use the UIDs from the matched data to subset the full dataset for analysis. Here is some code to demonstrate that
```{r echo = FALSE, message = FALSE, warning = FALSE}
